            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[1, 2, 3, 4, 5, 6].map((item) => (
                        <Link to="/post" key={item} className="flex flex-col bg-[var(--secondary-background-color)] rounded-lg overflow-hidden group shadow-md hover:shadow-xl transition-shadow duration-300">
                            <div className="relative h-64 overflow-hidden">
                                <img src={`/assets/images/older_posts/older_posts_${item}.jpg`} alt="" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                            </div>
                            <div className="p-6 flex flex-col flex-grow">
                                ...
                                <h3 className="text-xl font-bold text-[var(--light-color)] mb-3 group-hover:text-[var(--light-color-alt)] transition-colors">Sample article title</h3>
                                <p className="text-[var(--light-color-alt)] text-sm line-clamp-3 mb-4 flex-grow">
                                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Similique a tempore sapiente corporis, eaque fuga placeat odit voluptatibus.
                                </p>
                            </div>
                        </Link>
                    ))}
