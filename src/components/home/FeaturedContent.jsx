...
const FeaturedContent = () => {
    ...
    return (
        <div className="lg:col-span-2 flex flex-col gap-5">
            ...
            {/* Headline Banner */}
            <div className="bg-[var(--secondary-background-color)] flex items-center gap-4 p-4 rounded-lg shadow-sm">
                <h3 className="fancy-border shrink-0">
            ...
            {/* Articles */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 auto-rows-[minmax(20rem,auto)]">
